...
pub(super) static mut WIPIC_KNLINTERFACE: *const WIPICKnlInterface = ptr::null();
pub(super) static mut WIPI_JBINTERFACE: *const WIPIJBInterface = ptr::null();
pub(super) static mut WIPIC_GRAPHICS_INTERFACE: *const WIPICGraphicsInterface = ptr::null();
